...
public class TestGzip2 extends TestZipBase {
...
//	@Test
	...
	private static void compressGzipFile(String file, String gzipFile) {
		try {
			...
			CustomGZIPOutputStream gzipOS = new CustomGZIPOutputStream(fos, 512);
	...
	private void compressGzipFiletoNull(String file) {
		try {			
			...
			long t_start = System.currentTimeMillis();
			CustomGZIPOutputStream gzipOS = new CustomGZIPOutputStream(mos, 512);
